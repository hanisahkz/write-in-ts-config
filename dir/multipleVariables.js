...
var lhHumanAttributes;
lhHumanAttributes = ["james", 45, false, "blue"];
console.log("I am " + lhHumanAttributes[0] + ", aged " + lhHumanAttributes[1] + " years old. " +
...
var shArrayName = ["apple", "banana"];
var shArrayNumber = [23, 45 - 10];
var shArrayBool = [false, true];
var shArrayAny = ["some string", 45, false]; //similar to tuple
...
//single Type
var shArrayStrDiamond = ["purple", "black"];
var shArrayNumDiamond = [10, 11];
var shArrayAnyDiamond = ["brown", 123];
...
var shArrayMixDiamond = [true, 100];
...
//# sourceMappingURL=multipleVariables.js.map